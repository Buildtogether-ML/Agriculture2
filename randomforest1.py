...
st.title("Climate and Crop Prediction using Random Forest")
st.write("""
...
if uploaded_file is not None:
    ...
    area_input = st.selectbox("Select Area", df['Area'].unique())
    ...
    user_input_features = [area_encoded] + [other_features[col] for col in X.columns if col != 'Area']

    # Check if the number of columns matches
    if len(user_input_features) != len(X.columns):
